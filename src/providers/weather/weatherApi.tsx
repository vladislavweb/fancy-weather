          ...
          weatherThreeDays: {
            ru: [
              ...
              },
              {
                ...
                img: getWeatherImage(weathers.ru.list[16].sys.pod, weathers.ru.list[16].weather[0].icon.substring(0, 2)),
              },
              {
                ...
                img: getWeatherImage(weathers.ru.list[24].sys.pod, weathers.ru.list[24].weather[0].icon.substring(0, 2)),
              },
            ],
            en: [
              {
              ...
              },
              {
                ...
                img: getWeatherImage(weathers.en.list[16].sys.pod, weathers.en.list[16].weather[0].icon.substring(0, 2)),
              },
              {
                ...
                img: getWeatherImage(weathers.en.list[24].sys.pod, weathers.en.list[24].weather[0].icon.substring(0, 2)),
              },
            ],
            ua: [
              {
              ...
              },
              {
                ...
                img: getWeatherImage(weathers.ua.list[16].sys.pod, weathers.ua.list[16].weather[0].icon.substring(0, 2)),
              },
              {
                ...
                img: getWeatherImage(weathers.ua.list[24].sys.pod, weathers.ua.list[24].weather[0].icon.substring(0, 2)),
              },
            ],
          },
        });
